...
const routes = [
  ...
  { path: '/lessons-angular/js', component: JSView },
  { path: '/lessons-bitrix/js', component: JSView },
  { path: '/lessons-css/js', component: JSView },
  { path: '/lessons-html/js', component: JSView },
  { path: '/lessons-js/js', component: JSView },
  { path: '/lessons-linux/js', component: JSView },
  { path: '/lessons-racket/js', component: JSView },
  { path: '/lessons-react/js', component: JSView },
  { path: '/lessons-ts/js', component: JSView },
  { path: '/lessons-vue3/js', component: JSView },
  
  { path: '/lessons-angular/ts', component: TSView },
  { path: '/lessons-bitrix/ts', component: TSView },
  { path: '/lessons-css/ts', component: TSView },
  { path: '/lessons-html/ts', component: TSView },
  { path: '/lessons-js/ts', component: TSView },
  { path: '/lessons-linux/ts', component: TSView },
  { path: '/lessons-racket/ts', component: TSView },
  { path: '/lessons-react/ts', component: TSView },
  { path: '/lessons-ts/ts', component: TSView },
  { path: '/lessons-vue3/ts', component: TSView },
